...
public class LoadMovieFavoriteAsync extends AsyncTask<Void, Void, Cursor> {
    ...
    private final WeakReference<LoadFavoriteMovieCallback> mWeakCallback;

    public LoadMovieFavoriteAsync(Context mContext, LoadFavoriteMovieCallback mWeakCallback) {
